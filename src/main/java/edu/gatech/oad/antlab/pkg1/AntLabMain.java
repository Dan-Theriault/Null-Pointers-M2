 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Daniel Theriault");
		  toPrint += p1.toString("dtheriault3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Aaron Wasserman");
		  toPrint += p2.toString("awasserman6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nick Hutchinson");
		  toPrint += p3.toString("nhutchinson7");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Amethyst Sanders");
                  toPrint += p4.toString("asanders35");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Ivan Cvijetinovic");
                  toPrint += p5.toString("icvijetinovic3");
